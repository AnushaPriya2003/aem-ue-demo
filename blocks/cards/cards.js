...
export default function decorate(block) {
  ...
  block.setAttribute('data-aue-resource', `urn:aemconnection:${path}/jcr:content/root/section/cards`);
  ...
  [...block.children].forEach((row, i) => {
    ...
    li.setAttribute('data-aue-resource', `urn:aemconnection:${path}/jcr:content/root/section/cards/item_${i}`);
